...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=$_ENV['APP_URL']?>/home">
          <i class="bi bi-grid"></i>
          <span>Statistiques  </span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?=$_ENV['APP_URL']?>/GestionUtilisateur">
          <i class="bi bi-grid"></i>
          <span>Gestion des utilisateur</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?=$_ENV['APP_URL']?>/GestionMedicament">
          <i class="bi bi-grid"></i>
          <span>Gestion des Medicament </span>
        </a>
      </li>
      <li class="nav-item ">
        <a class="nav-link collapsed" href="<?=$_ENV['APP_URL']?>/GestionVents">
          <i class="bi bi-grid"></i>
          <span>Gestion des vents </span>
        </a>
      </li>
    </ul>
