    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 align-self-center">
          <img src="assets/user/assets/images/about-us-image.jpg" alt="">
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="video-thumb">
            <img src="assets/user/assets/images/video-thumb.jpg" alt="">
                    ...
                    <li class="active">
                      <div>
                        <div class="row">
                          ...
                          <div class="col-lg-5 align-self-center">
                            <img src="assets/user/assets/images/happyclient-01.jpg" alt="">
                          </div>
                        </div>
                      </div>
                    </li>
