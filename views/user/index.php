...
?>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/user/assets/images/services-01.jpg" alt="discover SEO" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/user/assets/images/services-02.jpg" alt="data analysis" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/user/assets/images/services-03.jpg" alt="precise data" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="assets/user/assets/images/services-04.jpg" alt="SEO marketing" class="templatemo-feature">
                </div>
  ...
  <div class="container" style="display: flex;align-items: center;justify-content: center;width: 100%;">
      <div class="main-button"><a href="#services">Get Started</a></div>
  </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="left-image">
                  <img src="assets/user/assets/images/left-infos.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="section-heading">
